...
export function ProduitCard({ produit, onAdd, isMobile }) {
  ...
  if (isMobile) {
    return (
      <div style={{
        padding: '14px 0', borderBottom: `1px solid rgba(200,184,0,0.15)`,
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <div style={{ display: 'flex', alignItems: 'baseline', gap: 4 }}>
            ...
            <span style={{ flex: 1, borderBottom: `1.5px dotted rgba(200,184,0,0.35)`, position: 'relative', top: -3, minWidth: 8 }} />
  ...
  return (
    <div style={{
      ...
      borderBottom: `1px solid rgba(200,184,0,0.15)`,
    }}>
      {hasImage && (
        <div style={{
      ...
      <div style={{ flex: 1 }}>
        <div style={{ display: 'flex', alignItems: 'baseline', gap: 6 }}>
          ...
          <span style={{ flex: 1, borderBottom: `1.5px dotted rgba(200,184,0,0.30)`, position: 'relative', top: -4 }} />
    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', userSelect: 'none' }}>
      ...
      <div style={{
        ...
        {pages.map((p, i) => (
          <button key={i} onClick={() => !flipping && setCurrentPage(i)} style={{
            ...
            transition: 'all 0.2s',
            boxShadow: i === currentPage ? `0 2px 10px rgba(200,184,0,0.30)` : 'none',
          }}>
      ...
      <div
        ...
        style={{
          ...
          boxShadow: `0 8px 40px rgba(45,48,0,0.12), 0 2px 8px rgba(45,48,0,0.06)`,
          transform: flipping
