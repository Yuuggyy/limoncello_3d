    ...
    <div style={{
      ...
      <header style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, minWidth: 0 }}>
          ...
          <div style={{ minWidth: 0 }}>
            ...
            }}>{parametres?.nom_restaurant || 'Limoncello'}</h1>
            {!isMobile && (
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: isMobile ? 8 : 12, flexShrink: 0 }}>
          <button onClick={() => setShowAppel(true)} style={{
            ...
            border: '1px solid rgba(200,184,0,0.40)',
          ...
          <button onClick={() => setShowPanier(true)} style={{
            ...
            whiteSpace: 'nowrap',
            boxShadow: totalItems > 0 ? `0 4px 16px rgba(200,184,0,0.35)` : 'none',
          }}>
            🛒 {!isMobile && L.panier}
            {totalItems > 0 && (
              <span style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          background: 'rgba(255,255,255,0.10)',
          border: `1px solid rgba(200,184,0,0.25)`,
          borderRadius: 10,
      ...
      {showAppel && (
        <div style={{
          ...
          <div style={{
            ...
            boxShadow: '0 20px 60px rgba(45,48,0,0.25)',
      ...
      {toast && (
        <div style={{
          ...
          boxShadow: '0 8px 24px rgba(45,48,0,0.25)',
