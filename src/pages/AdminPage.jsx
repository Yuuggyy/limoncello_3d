...
const C = {
  ...
  danger:      '#C0392B',
  warning:     '#D4891A',
  goldDeep:   '#6B5A00', // higher-contrast gold for text on white/light backgrounds
  successDark:'#155C36', // higher-contrast green for text on white/light backgrounds
  dangerDark: '#8E2A1E', // higher-contrast red for text on white/light backgrounds
  warningDark:'#8A4E00', // higher-contrast amber for text on white/light backgrounds
};
